export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxe4c21c68b8ce6ab4",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "9172e359d57e3977e2a2233439135e8d",
  ...
  USERS: [
    {
      ...
      id: "oHldF6LXK-JcUQNtNE3Drah-Z5X0",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "fMFPs6dibWFovNwzA3bCKTWjEMDIK1Lq3xggheOUBFs",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2000", "date": "09-09"},
